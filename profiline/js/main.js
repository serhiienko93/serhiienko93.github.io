jQuery(function($){
  ...
  $('.btn-search').click(function(){
   if($(this).parent().is('.search-form--opened')){
    $(this).parent().removeClass('search-form--opened');
   }else{
    $(this).parent().addClass('search-form--opened');
   }
  });
...
$(document).bind('click touchstart', function(e) {
  ...
  if (! $clicked.parents().hasClass("search-form")){
  ...
  $('.brands__icon').click(function(){
   if($(this).parent().is('.brands--opened')){
    $(this).parent().removeClass('brands--opened');
   }else{
    $(this).parent().addClass('brands--opened');
   }
  });


  $('.menu-all__title').click(function(){
   if($(this).parent().is('.menu-all--opened')){
    $(this).parent().removeClass('menu-all--opened');
   }else{
    $(this).parent().addClass('menu-all--opened');
   }
  });


  $('.brand-nav-list__icon').click(function(){
   if($(this).parent().is('.brand-nav-list--opened')){
    $(this).parent().removeClass('brand-nav-list--opened');
   }else{
    $(this).parent().addClass('brand-nav-list--opened');
   }
  });

  $('.aside-nav-item__title').click(function(){
   if($(this).parent().is('.aside-nav-item--open')){
    $(this).parent().removeClass('aside-nav-item--open');
    $(this).parent().find('.aside-nav-item__list').slideUp(200);
   }else{
    $('.aside-nav-item').removeClass('aside-nav-item--open');
    $(this).parent().addClass('aside-nav-item--open');
    $('.aside-nav-item__list').slideUp(200);
    $(this).parent().find('.aside-nav-item__list').slideDown(200);
   }
  });
    ...
    $(window).scroll(function() {
      if ($(this).scrollTop() > 80){  
        $('.header').addClass("fixed-card");
      }
      else{
        $('.header').removeClass("fixed-card");
      }
    });
